...
import layout from "./layout-wx";
import extendEvent from "./event";

export default function ({ createCanvas }) {
  const wordCloudLayoutHelper = layout(createCanvas);

  if (!wordCloudLayoutHelper.isSupported) {
    throw new Error("Sorry your environment not support wordCloud");
  }
